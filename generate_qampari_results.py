...
if __name__ == '__main__':
    ...
    # python generate_qampari_results.py --input_file outputs_qampari/output_qwen3-0.6b_finetuned_RL.jsonl --output_file outputs_qampari/last_query/output_qwen3-0.6b_finetuned_RL.jsonl
    # python generate_qampari_results.py --input_file outputs_qampari/output_contriever_finetuned_RL.jsonl --output_file outputs_qampari/last_query/output_contriever_finetuned_RL.jsonl
    # python generate_qampari_results.py --input_file outputs_qampari/output_infly_finetuned_RL.jsonl --output_file outputs_qampari/last_query/output_infly_finetuned_RL.jsonl
    ...
    # python generate_qampari_results.py --input_file outputs_qampari/output_qwen3-0.6b_finetuned_RL.jsonl --last_query_search_results /scratch/hc3337/projects/autoregressive/results/base_retrievers/qwen3-0.6b/qampari_last_queries_searchr1_RL.jsonl --command combine_results --topk 100 --output_file /scratch/hc3337/projects/autoregressive/results/base_retrievers/qwen3-0.6b/qampari_agentic_final_results_topk100_searchr1_RL.jsonl
    # python generate_qampari_results.py --input_file outputs_qampari/output_contriever_finetuned_RL.jsonl --last_query_search_results /scratch/hc3337/projects/autoregressive/results/base_retrievers/contriever/qampari_last_queries_searchr1_RL.jsonl --command combine_results --topk 100 --output_file /scratch/hc3337/projects/autoregressive/results/base_retrievers/contriever/qampari_agentic_final_results_topk100_searchr1_RL.jsonl
    # python generate_qampari_results.py --input_file outputs_qampari/output_infly_finetuned_RL.jsonl --last_query_search_results /scratch/hc3337/projects/autoregressive/results/base_retrievers/infly/qampari_last_queries_searchr1_RL.jsonl --command combine_results --topk 100 --output_file /scratch/hc3337/projects/autoregressive/results/base_retrievers/infly/qampari_agentic_final_results_topk100_searchr1_RL.jsonl